...
class Visualizer extends Component {
    ...
    deleteSelectedCode=(event,code_id)=>{
        this.setState({deletedKey:code_id});
        setTimeout(() => {
                        ...
                        <div className={this.props.data.scroll__class} style={{width:'100%',height:'400px',overflowY:'scroll',display:'flex',justifyContent:'flex-start',alignItems:'center',flexDirection:'column'}}>
                            ...
                            this.props.data_code.codeList.map(item=>{
                                    return(
                                        ...
                                        <div onClick={(event)=>this.updateCurrentCode(event,item._id)} style={{display:'flex',justifyContent:'flex-start',alignItems:'flex-start',fontFamily:'monospace',padding:'3px',color:'#eee',opacity:'0.3',width:'100%',minHeight:'150px',backgroundColor:'rgba(120, 144, 156,0.3)'}}>
                                        ...
                                        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',width:'100%',minHeight:'50px'}}>
                                            ...
                                            {!item.defaultCode && <motion.span onClick={(event)=>this.deleteSelectedCode(event,item._id)} initial={{color:'#fff',fontSize:'30px',marginRight:'10px'}} whileHover={{color:'#EEFF41'}}><Edit/></motion.span>}
